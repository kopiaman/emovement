...
$layout->blocks["top"][] = "details";$page_layouts["user_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='user_edit.php?".$editlink."'\"");
