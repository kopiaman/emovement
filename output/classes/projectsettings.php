...
function GetTableURL($table = "")
{
	...
	if("user" == $table) 
		return "user";
	if("user_profile" == $table) 
		return "user_profile";
	if("alltest" == $table) 
		return "alltest";
	if("my_timetable" == $table) 
		return "my_timetable";
	if("department" == $table) 
		return "department";
	if("department_sub" == $table) 
		return "department_sub";
	if("User Access Level" == $table) 
...
{	
	...
	if("user" == $shortTName) 
		return "user";
	if("user_profile" == $shortTName) 
		return "user_profile";
	if("alltest" == $shortTName) 
		return "alltest";
	if("my_timetable" == $shortTName) 
		return "my_timetable";
	if("department" == $shortTName) 
		return "department";
	if("department_sub" == $shortTName) 
		return "department_sub";
	if("User_Access_Level" == $shortTName) 
		return "User Access Level";
	if("User_Level" == $shortTName) 
		return "User_Level";
	if("training" == $shortTName) 
		return "training";
	if("feedback" == $shortTName) 
		return "feedback";
}
