	...
	function addCommonJs() 
	{
		if ($this->debugJSMode === true)
		{
			...
			if ($this->pSet->isAddPageEvents())
			{
				...
				$this->AddJSFile("include/runnerJS/events/globalevents.js", "include/runnerJS/pages/PageSettings.js", 
					"include/runnerJS/button.js");
			}
		}
		else
		{
			if ($this->pSet->isAddPageEvents())
			{
			 	if( $this->mode != LIST_DETAILS)
			 	{
					...
					if ($this->pageType == PAGE_MENU || $this->pageType == PAGE_REGISTER || $this->pageType == PAGE_LOGIN || $this->pageType == PAGE_CHANGEPASS || $this->pageType == PAGE_REMIND){
				$this->AddJSFile("include/runnerJS/events/globalevents.js", "include/runnerJS/RunnerControls.js", 
					"include/runnerJS/RunnerPages.js");
			}
		}
