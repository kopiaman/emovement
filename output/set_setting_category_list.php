...
include_once("include/setting_settings.php");
...
$layout = new TLayout("list6","ExtravaganzaOrange1","MobileOrange1");
...
$layout->blocks["top"][] = "recordcontrols";$page_layouts["set_setting_category_list"] = $layout;
...
{	
	...
	//determine which field should be used to select values
			$params["lookupSelectField"] = "category_name";
}
