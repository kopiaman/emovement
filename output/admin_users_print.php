...
$layout = new TLayout("print","ExtravaganzaOrange","MobileOrange");
...
//	umail - 
			$record["umail_value"] = $pageObject->showDBValue("umail", $data, $keylink);
			$record["umail_class"] = $pageObject->fieldClass("umail");
//	icno - 
			$record["icno_value"] = $pageObject->showDBValue("icno", $data, $keylink);
			$record["icno_class"] = $pageObject->fieldClass("icno");
//	pos - 
			$record["pos_value"] = $pageObject->showDBValue("pos", $data, $keylink);
			$record["pos_class"] = $pageObject->fieldClass("pos");
			if($col<$colsonpage)
...
$xt->assign("umail_fieldheadercolumn",true);
$xt->assign("umail_fieldheader",true);
$xt->assign("umail_fieldcolumn",true);
$xt->assign("umail_fieldfootercolumn",true);
$xt->assign("icno_fieldheadercolumn",true);
$xt->assign("icno_fieldheader",true);
$xt->assign("icno_fieldcolumn",true);
$xt->assign("icno_fieldfootercolumn",true);
$xt->assign("pos_fieldheadercolumn",true);
$xt->assign("pos_fieldheader",true);
$xt->assign("pos_fieldcolumn",true);
$xt->assign("pos_fieldfootercolumn",true);
