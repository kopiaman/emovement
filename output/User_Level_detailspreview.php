...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["User_Level_detailspreview"] = $layout;
...
if($mastertable == "User Access Level")
{
	$where = "";
		$where .= GetFullFieldName("UserName", $strTableName, false)."=".make_db_value("UserName",$_SESSION[$strTableName."_masterkey1"]);
}
...
$xt->load_template("User_Level_detailspreview.htm");
