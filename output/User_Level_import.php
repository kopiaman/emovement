...
// keys array
$keys[]=AddFieldWrappers("UserName");
$keys[]=AddFieldWrappers("GroupID");
$keys_present=1;
...
$layout = new TLayout("import","ExtravaganzaOrange","MobileOrange");
...
$layout->blocks["top"][] = "import";$page_layouts["User_Level_import"] = $layout;
...
$xt->display("User_Level_import.htm");
