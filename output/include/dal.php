...
class tDAL
{
	...
	function FillTablesList()
	{
	  ...
	  $this->lstTables[]=array("name"=>"timetable","varname"=>"timetable");
	  $this->lstTables[]=array("name"=>"setting","varname"=>"setting");
	  $this->lstTables[]=array("name"=>"emov_ugrights","varname"=>"emov_ugrights");
	  $this->lstTables[]=array("name"=>"user","varname"=>"user");
	  $this->lstTables[]=array("name"=>"department","varname"=>"department");
	  $this->lstTables[]=array("name"=>"department_sub","varname"=>"department_sub");
	  $this->lstTables[]=array("name"=>"emov_ugmembers","varname"=>"emov_ugmembers");
	  $this->lstTables[]=array("name"=>"training","varname"=>"training");
	  $this->lstTables[]=array("name"=>"feedback","varname"=>"feedback");
	  $this->lstTables[]=array("name"=>"emov_uggroups","varname"=>"emov_uggroups");
	}
