...
$layout->blocks["top"][] = "details";$page_layouts["User_Access_Level_view"] = $layout;
...
$arr = array();
$arr['fName'] = "umail";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("umail");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "fullname";
...
$arr = array();
$arr['fName'] = "pos";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("pos");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "totalrecord";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("totalrecord");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "sstatus";
...
//umail - 
	...
	if($mainTableOwnerID=="umail")
		$ownerIdValue=$value;
	$xt->assign("umail_value",$value);
...
//pos - 
	...
	if($mainTableOwnerID=="pos")
		$ownerIdValue=$value;
	$xt->assign("pos_value",$value);
...
//totalrecord - 
	...
	if($mainTableOwnerID=="totalrecord")
		$ownerIdValue=$value;
	$xt->assign("totalrecord_value",$value);
	if(!$pageObject->isAppearOnTabs("totalrecord"))
		$xt->assign("totalrecord_fieldblock",true);
	else
		$xt->assign("totalrecord_tabfieldblock",true);
////////////////////////////////////////////
//sstatus - Custom
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='User_Access_Level_edit.php?".$editlink."'\"");
