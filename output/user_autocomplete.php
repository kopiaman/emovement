...
$pageType = postvalue('pageType');
	...
	if($field=="icno")
		$checkField	=false;
//	$checkField	&= ($field!="icno");
	if($field=="pass")
		$checkField	=false;
//	$checkField	&= ($field!="pass");
	if($field=="fullname")
		$checkField	=false;
//	$checkField	&= ($field!="fullname");
	if($field=="pos")
		$checkField	=false;
//	$checkField	&= ($field!="pos");
	if($field=="umail")
		$checkField	=false;
//	$checkField	&= ($field!="umail");
	if($field=="department")
		$checkField	=false;
//	$checkField	&= ($field!="department");
	if($field=="subdepartment")
		$checkField	=false;
//	$checkField	&= ($field!="subdepartment");
	if($field=="sstatus")
		$checkField	=false;
//	$checkField	&= ($field!="sstatus");
	if ($checkField)
	{
		if(!isLogged()) { return;	}
