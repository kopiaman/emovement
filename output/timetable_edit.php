...
$templatefile = ($inlineedit == EDIT_INLINE) ? "timetable_inline_edit.htm" : "timetable_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: timetable_".$pageObject->getPageType().".php?".$keyGetQ);
...
//	fid - 
	$value = $pageObject->showDBValue("fid", $data, $keylink);
	$showValues["fid"] = $value;
	$showFields[] = "fid";
...
//	day - 
	$value = $pageObject->showDBValue("day", $data, $keylink);
...
//	date_status - Short Date
	$value = $pageObject->showDBValue("date_status", $data, $keylink);
	$showValues["date_status"] = $value;
	$showFields[] = "date_status";
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='timetable_view.php?".$viewlink."'\"");
